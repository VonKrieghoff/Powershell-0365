...
#$SetAsDefaultBrowser = "ChromeHTML"
...
Write-Progress -Activity  "Default Browser is $HTTPBrowser"
...
if($HTTPBrowser -ne $SetAsDefaultBrowser)
{
 ...
 Write-Progress -Activity "Curent Default Browser is $HTTPBrowser, Changing default browser to $SetAsDefaultBrowser"
...
# else {Write-Output "DEfault HTTP browser already is $HTTPBrowser" }
...
#else {Write-Output "DEfault HTTPS browser already is $HTTPSBrowser" }
